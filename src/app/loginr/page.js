...
<div className="relative mt-3">
  <input
    type="email"
    placeholder="E-mail"
    className="w-full  p-2 border border-[#EF4444] bg-[#FFF2F1] text-[#EF4444] rounded-md focus:outline-none focus:ring-2 focus:ring-[#EF4444] placeholder-[#EF4444]"
  />
  <p className="text-[#EF4444] text-sm mt-1">Veuillez entrer une adresse e-mail valide.</p>
</div>
