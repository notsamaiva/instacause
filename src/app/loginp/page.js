  ...
  return (
    ...
    <div className="w-full md:w-[458px] h-auto md:h-[686.75px] mt-10 md:mt-[60px] flex flex-col justify-center items-center p-6 md:p-10 gap-6 md:gap-[53px]">
        ...
        <div className="w-full max-w-xs md:max-w-md">
          ...
          {/* Bouton Connexion */}
          <button className="w-full bg-[#d8dbe3] text-[#6f7580] p-2 rounded-md mt-4 font-bold text-sm 
  hover:bg-[#0B99FF] hover:text-white active:bg-[#0B99FF] active:text-white">
  Se connecter
</button>
